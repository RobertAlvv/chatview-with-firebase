...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = const Color(0xFF083CE5),
    ...
    Color backArrowColor = const Color(0xFF083CE5),
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = const Color(0xFF083CE5),
    ...
    Color outgoingChatBubbleColor = const Color(0xFF083CE5),
    ...
    Color sendButtonColor = const Color(0xFF083CE5),
    ...
    Color verticalBarColor = const Color(0xFF083CE5),
